class NPCSystem {
    ...
    initUI() {
        ...
        if (this.npcNameEl) {
            this.npcNameEl.innerText = this.npc.name;
        }
    ...
    updateDialog() {
        ...
        if (this.currentDialogIndex < dialogs.length) {
            ...
            if (this.nextBtn) {
                if (this.currentDialogIndex === dialogs.length - 1) {
                    this.nextBtn.innerText = '🏁 Kết thúc';
                } else {
                    this.nextBtn.innerText = '➡ Tiếp';
                }
            }
        } else {
            this.closeDialog();
